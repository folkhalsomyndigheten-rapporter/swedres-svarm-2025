...
All data on the number of DDDs in this report are displayed in the 2025 version of the ATC/DDD index, available at [www.whocc.no/atc_ddd_index](https://www.whocc.no/atc_ddd_index/){target="_blank"}. 
...
In the report, some general regression models were executed in @sec-ash - [Sales of antibiotics in humans](#sec-ash). Time was used as explanatory variable and the outcome was the sales of antibiotics, adjusted for population size in Sweden, data on population provided by the eHealth Agency. The analyses were executed on a basis of a negative binomial distribution. 
